...
export default function MobileSidebar({ sidebarData }: MobileSidebarProps) {
  ...
  return (
    <header className='lg:hidden sticky top-0 z-10 w-full bg-background/95 shadow backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:shadow-secondary  border-b'>
